...
#  endif
            ...
            _interpreter() {
                ...
                PyObject* mpl_toolkitsmod = nullptr;
                PyObject* axis3dmod;
                if (!mpl_toolkitsmod) {
    ...
    template<typename Numeric>
    bool plot2D(PyObject* ax, const std::vector<Numeric>& x, const std::vector<Numeric>& y, std::string color, double linewidth)
    {
        assert(x.size() == y.size());
    ...
    template<typename Numeric>
    bool scatter2D(PyObject* ax, const std::vector<Numeric>& x, const std::vector<Numeric>& y, std::string color, double size)
    {
        assert(x.size() == y.size());
    ...
    bool scatter2DX(PyObject* ax, double x, double y, std::string color, double size)
    {
    ...
    bool scatter3DX(PyObject* ax, double x, double y, double z, std::string color, double size)
    {
        ...
        PyTuple_SetItem(args, 0, PyFloat_FromDouble(x));
        PyTuple_SetItem(args, 1, PyFloat_FromDouble(y));
        PyTuple_SetItem(args, 2, PyFloat_FromDouble(z));
        ...
        double linewidth)
    {
        ...
        PyObject* theplot = PyObject_GetAttrString(ax, "plot3D");
    ...
    template<typename Numeric>
    void set_zlim(PyObject* ax, Numeric left, Numeric right) {
        ...
        PyObject* zaxis = PyObject_GetAttrString(ax, "set_zlim");
        PyObject_CallObject(zaxis, args);
    }
